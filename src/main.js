...
const createTripSearchTemplate = () => {
  return (
...
//add-first-event && add-new-event-without-destination && add-new-event-without-destination
render(tripEvents.children[0], createEditTripEventsItem(), `afterend`);

//trip-days с выбором впоследствии какую карточку отрисовывать в зависимости от данных
